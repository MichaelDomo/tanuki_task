...
Основная цель разработчиков, которым интересно программирование -- это работать в компании единомышленников. Следующие пункты позволяют вполне конкретно сказать, подходим ли мы друг другу:
https://docs.google.com/document/d/155PCRPgNwGCHJHd_RlmBzKV5FaQeU6HHFbMHNCq8aRc/edit
